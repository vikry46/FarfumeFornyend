        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <h1 className='mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2'>Welocome My Farfume</h1>
                  ...
                  <div className="relative">
                    ...
                    >
                      {showPassword ? (
                        ...
                        <svg className="fill-current" width="22" height="22" viewBox="0 0 24 24" fill="none">
                          <path
                            d="M17.94 17.94A9.97 9.97 0 0 1 12 20c-7 0-11-8-11-8a21.93 21.93 0 0 1 5.34-6.1M22 4L2 22"
                            stroke="currentColor"
                            strokeWidth="2"
                          />
                        </svg>
